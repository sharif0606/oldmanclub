...
*/
                ...
                (function ($) {
                    ...
                    channel.bind("my-group", function (data) {
                        ...
                        if (data.group_id == dataid) {
                            if (my_id == data.to_user_id) {
                                ...
                                $.each(
                                    JSON.parse(
                                        JSON.stringify(data.group_users)
                                    ),
                                    function (key, value) {
                                        if (value.id == my_id) {
                                            getgrouplastmessage(data.group_id);
                    ...
                    $(document).on(
                        "keydown",
                        ".chat-input .emoji-wysiwyg-editor",
                        function (event) {
                            if (event.which == 13) {
                    ...
                    $(document).on("click", ".create-group", function () {
                        var testing =
                            document.getElementsByClassName("batchCheckbox");
                        var checkVal = [];
                    ...
                    function getgrouplastmessage(data) {
                        $.ajax({
                            ...
                            cache: false,
                            success: function success(data) {
                                $(".chat-conversation #chatgroup-ul").append(
                                    data
                                );
                                scrollToBottomFunc();
                            },
                    ...
                    function initSettings() {
                        $("#light-dark").on("click", function (e) {
                            ...
                            if (
                                $("#bootstrap-style").attr("disabled") !==
                                "disabled"
                            ) {
                                $("#bootstrap-dark-style").attr(
                                    "disabled",
                                    false
                                );
  ...
  \**********************************************************************************************************************************************************************************************************/
            ...
            /***/ function (module, exports, __webpack_require__) {
                __webpack_require__(
                    /*! /opt/lampp/htdocs/ChatviaLaravel/resources/js/pages/index.init.js */ "./resources/js/pages/index.init.js"
                );
                __webpack_require__(
                    /*! /opt/lampp/htdocs/ChatviaLaravel/resources/scss/bootstrap.scss */ "./resources/scss/bootstrap.scss"
                );
                __webpack_require__(
                    /*! /opt/lampp/htdocs/ChatviaLaravel/resources/scss/bootstrap-dark.scss */ "./resources/scss/bootstrap-dark.scss"
                );
                __webpack_require__(
                    /*! /opt/lampp/htdocs/ChatviaLaravel/resources/scss/icons.scss */ "./resources/scss/icons.scss"
                );
                __webpack_require__(
                    /*! /opt/lampp/htdocs/ChatviaLaravel/resources/scss/app.scss */ "./resources/scss/app.scss"
                );
                module.exports = __webpack_require__(
                    /*! /opt/lampp/htdocs/ChatviaLaravel/resources/scss/app-dark.scss */ "./resources/scss/app-dark.scss"
                );
