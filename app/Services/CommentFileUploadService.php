...
use App\Models\User\CommentFile;
use Exception;

class CommentFileUploadService
{
    /**
     ...
     * @param int $postId
     * @return CommentFile|null
     * @throws Exception
     */
    public function uploadCommentFile($file, int $commentId)
    {
        try {
    ...
    {
        $uploadPath = public_path('uploads/comment/' . $directory . '/' . $filefolder);
    ...
    {
        $fullPath = public_path('uploads/comment/' . $filePath);
