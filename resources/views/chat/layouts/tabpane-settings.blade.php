    ...
    <div class="text-center border-bottom p-4">
        <div class="mb-4 profile-user">
            <form name="avatar-form" id="avatar-form" method="post" accept-charset="utf-8" enctype="multipart/form-data"
                ...
                <img id="imgAvatar" src="{{ asset('public/uploads/client/' . $client->image) }}"
        ...
        <h5 id="user-profile-name" class="font-size-16 mb-1 text-truncate profile-newname">{{ $client->display_name }}</h5>
                ...
                <div id="profile-setting-personalinfocollapse" class="collapse show"
                    ...
                    <div class="card-body">
                        ...
                        <div>
                            ...
                            <h5 id="profile-newname" class="font-size-14 profile-newname text-truncate">{{ $client->display_name }}</h5>
