            ...
            <form action="{{ route('nfc_card.update', encryptor('encrypt', $nfc_card->id)) }}" method="post" class="row">
                ...
                <div class="col-12">
                    ...
                    <div class="row">
                        <div class="col-4 form-group">
                            ...
                            <input type="text" name="prefix" value="{{ $nfc_card->nfc_info->prefix }}" id=""
                                class="form-control">
                        </div>
                        <div class="col-4 form-group">
                            <label for="">Preferred Name</label>
                            <input type="text" name="preferred_name" value="{{ $nfc_card->nfc_info->preferred_name }}"
                                id="" class="form-control">
                        </div>
                        <div class="col-4 form-group">
                            <label for="">Maiden Name</label>
                            <input type="text" name="maiden_name" value="{{ $nfc_card->nfc_info->maiden_name }}"
                                id="" class="form-control">
                        </div>
                        <div class="col-4 form-group">
                            <label for="">Suffix</label>
                            <input type="text" name="suffix" value="{{ $nfc_card->nfc_info->suffix }}" id=""
                                class="form-control">
                        </div>
                        <div class="col-4 form-group">
                            <label for="">Accreditations</label>
                            <input type="text" name="accreditations" value="{{ $nfc_card->nfc_info->accreditations }}"
                                id="" class="form-control">
                        </div>
                        <div class="col-4 form-group">
                            <label for="">Pronoun</label>
                            <input type="text" name="pronoun" value="{{ $nfc_card->nfc_info->pronoun }}" id=""
                                class="form-control">
                        </div>
                        <div class="col-6 form-group">
                            <label for="">Department</label>
                            <input type="text" name="department" value="{{ $nfc_card->nfc_info->department }}"
                                id="" class="form-control">
                        </div>
                        <div class="col-6 form-group">
                            <label for="">Company</label>
                            <input type="text" name="company" value="{{ $nfc_card->nfc_info->company }}" id=""
                                class="form-control">
                        </div>
                        <div class="col-6 form-group">
                            <label for="">Headline</label>
                            <input type="text" name="headline" value="{{ $nfc_card->nfc_info->headline }}"
                                id="" class="form-control">
                        </div>
                        <div class="col-6 form-group">
                ...
                <div class="col-12">
                    ...
                    <select class="form-control mb-3" id="" name="design_card_id" required>
                        ...
                        <option value="1" @if ($nfc_card->card_design?->design_card_id == 1) selected @endif>Classic</option>
                        <option value="2" @if ($nfc_card->card_design?->design_card_id == 2) selected @endif>Flat</option>
                        <option value="3" @if ($nfc_card->card_design?->design_card_id == 3) selected @endif>Modern</option>
                        <option value="4" @if ($nfc_card->card_design?->design_card_id == 4) selected @endif>Sleek</option>
                    </select>
                </div>
                <div class="col-12">
                    ...
                    <div class="row">
                                    ...
                                    @forelse ($nfc_card->nfcFields as $value)
                                        ...
                                        <div class="selected-field-item px-3 my-1">
                                            ...
                                            <input type="hidden" class="form-control"
                                                value="{{ $value->pivot->nfc_field_id }}" name="nfc_field_id[]">
                                        </div>
                                    @empty
                                    @endforelse
                                </div>
                        ...
                        <div class="col-md-4" id="field-gallery" style="max-height:400px;overflow-y:scroll">
        ...
        $(document).ready(function() {
            ...
            function addSelectedField(field, id) {
                ...
                var selectedFieldHtml = '<div class="selected-field-item px-3 my-1">\
                    ...
                    '" class="form-label d-flex justify-content-between">' + field +
                    '<span class="delete-btn"><i class="fa fa-close"></i></span></label>\
                                                                                    <input type="text" class="form-control" id="' +
                    field
                    .toLowerCase() +
