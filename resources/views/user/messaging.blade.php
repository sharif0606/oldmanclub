                        ...
                        <a href="#">
                          <div class="d-flex">
                            <div class="flex-shrink-0 avatar avatar-story me-2 status-{{ Cache::has('is_online' . $user->id) ? 'online' : 'offline' }}">
                              ...
                              <img class="avatar-img rounded-circle" src="{{ $user->image? asset('public/uploads/client/' . $user->image) : asset('public/images/download.jpg') }}" alt="">
                              @else
                              <img class="avatar-img rounded-circle" src="{{ $user->image? asset('public/uploads/client/' . $user->image) : asset('public/images/download.jpg') }}" alt="">
                              @endif
                            </div>
                            <div class="flex-grow-1 d-block">
                              ...
                              @else
                              <div class="small text-secondary">{{ $user->message }}</div>
                              @endif
                              @else
