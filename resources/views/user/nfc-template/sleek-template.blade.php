<div class="background">
   <div class="">
        <div class="header_sleek" style="width: 100%">
            ...
            <div class="css-1fbwa35 " style="background: #E2E8F0">
                <div class="card sleek_card mx-auto mb-3">
                    <div class="card_img">
                    <img class="logo-image-preview" src="{{  $nfc_card->card_design?->logo ? asset('public/uploads/cards/' .$nfc_card->card_design?->logo) : asset('public/assets/nfc/images/logo.png') }}" alt="abc" width="50px" height="50px"
                        />
    ...
    <div class="container mt-5" >
        <div class="">
            <p class=" headline">{{  $nfc_card->nfc_info?->headline ?? '' }}</p>
