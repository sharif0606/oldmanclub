                    ...
                    <div class="card-body">
                        ...
                        <form method="post" enctype="multipart/form-data"
                            ...
                            <div class="col-lg-6">
                                ...
                                <select name="marital_status" id="" value="{{ $client->marital_status }}"
                                    class="form-control">
                            ...
                            <div class="col-sm-6 col-lg-3">
                                ...
                                <select name="current_country_id" id="" onchange="$('.scountry').hide();$('.scountry'+this.value).show()" class="form-control" onchange="showState(this.value)" >
                                    <option value="">Select country</option>
                                    @foreach ($country as $value)
                                        <option value="{{ $value->id }}" @if (old('current_country_id', $client->current_country_id) == $value->id) selected @endif>{{ $value->name }}</option>
                                    @endforeach
                                </select>
                            </div>
                            <div class="col-sm-6 col-lg-3">
                                <label class="form-label">Current State</label>
                                <select name="current_state_id" id="" onchange="$('.sstate').hide();$('.sstate'+this.value).show()" class="form-control" onchange="showCity(this.value)">
                                    <option value="">Select State</option>
                                    @foreach ($state as $value)
                                        <option value="{{ $value->id }}" class="scountry scountry{{$value->country_id}}" @if (old('current_state_id', $client->current_state_id) == $value->id) selected @endif>{{ $value->name }}</option>
                                    @endforeach  
                                </select>
                            </div>
                            <div class="col-sm-6 col-lg-3">
                                <label class="form-label">Current City</label>
                                <select name="current_city_id" id="" class="form-control">
                                    <option value="">Select City</option>
                                    @foreach ($city as $value)
                                        <option value="{{ $value->id }}" class="sstate sstate{{$value->state_id}}" {{old('city_id')==$value->id?"selected":""}}>{{ $value->name }}</option>
                                    @endforeach 
                                </select>
                            </div>
                            <div class="col-sm-6 col-lg-3">
                                <label class="form-label">Zip Code</label>
                                <input type="text" placeholder="" value="{{ $client->current_zip_code }}"
                                    class="form-control"name="current_zip_code">
                            </div>
                            <div class="col-sm-6 col-lg-3">
                                <label class="form-label">From Country</label>
                                <select name="from_country_id" id="" onchange="$('.scountry').hide();$('.scountry'+this.value).show()" class="form-control" onchange="showState(this.value)" >
                                    <option value="">Select country</option>
                                    @foreach ($country as $value)
                                        <option value="{{ $value->id }}" @if (old('current_country_id', $client->from_country_id) == $value->id) selected @endif>{{ $value->name }}</option>
                                    @endforeach
                                </select>
                            </div>
                            <div class="col-sm-6 col-lg-3">
                                <label class="form-label">From State</label>
                                <select name="from_state_id" id="" onchange="$('.sstate').hide();$('.sstate'+this.value).show()" class="form-control" onchange="showCity(this.value)">
                                    <option value="">Select State</option>
                                    @foreach ($state as $value)
                                        <option value="{{ $value->id }}" class="scountry scountry{{$value->country_id}}" @if (old('current_state_id', $client->from_state_id) == $value->id) selected @endif>{{ $value->name }}</option>
                                    @endforeach  
                                </select>
                            </div>
                            <div class="col-sm-6 col-lg-3">
                                <label class="form-label">From City</label>
                                <select name="from_city_id" id="" class="form-control">
                                    <option value="">Select City</option>
                                    @foreach ($city as $value)
                                        <option value="{{ $value->id }}" class="sstate sstate{{$value->state_id}}" @if (old('from_city_id', $client->from_city_id) == $value->id) selected @endif>{{ $value->name }}</option>
                                    @endforeach 
                                </select>
                            </div>
                            <div class="col-sm-6 col-lg-3">
