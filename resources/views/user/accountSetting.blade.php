                        ...
                        <div class="tab-pane fade active show" id="nav-setting-tab-1" role="tabpanel">
                            ...
                            <div class="card mb-4">
                                ...
                                <div class="card-header border-0 pb-0">
                                    ...
                                    <p class="text-primary"><strong>TO MAKE YOUR INFORMATION PUBLIC OR PRIVATE USE TOGGLE RIGHT AFTER INFORMATION BOX NAME</strong></p>
                                ...
                                <div class="card-body">
                                    ...
                                    <form method="post" enctype="multipart/form-data"
                                        ...
                                        <div class="col-sm-6 col-lg-3">
                                            ...
                                            <select name="current_country_id" class="form-control" onchange="fetchStates(this.value)">
                                        ...
                                        <div class="col-sm-6 col-lg-3">
                                            ...
                                            <select name="current_state_id" id="state-dropdown" class="form-control" onchange="fetchCities(this.value)">
                                        ...
                                        <div class="col-sm-6 col-lg-3">
                                            ...
                                            <select name="from_country_id" class="form-control" onchange="fetchStatesFrom(this.value)">
                                                <option value="">Select country</option>
                                                @foreach ($countries as $value)
                                                    <option value="{{ $value->id }}"
                                        ...
                                        <div class="col-sm-6 col-lg-3">
                                            ...
                                            <select name="from_state_id" id="from-state-dropdown" class="form-control" onchange="fetchCitiesFrom(this.value)">
                                                <option value="">Select State</option>
                                            </select>
                                        </div>
                                        <div class="col-sm-6 col-lg-3">
        ...
        function fetchStatesFrom(countryId) {
            $.ajax({
                ...
                success: function(response) {
                    ...
                    $.each(response, function(index, state) {
                        $('#from-state-dropdown').append('<option value="' + state.id + '">' + state.name +
                            '</option>');
                    });
                },
                error: function(xhr, status, error) {
