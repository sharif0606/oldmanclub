...
<head>
    <title> - Network, Community and Event</title>
        ...
        <nav class="navbar navbar-expand-lg">
            <div class="container">
                ...
                <a class="navbar-brand" href="index-2.html">
                    <img class="light-mode-item navbar-brand-item" src="{{asset('public/user/assets/images/logo.svg')}}" alt="logo">
                    <img class="dark-mode-item navbar-brand-item" src="{{asset('public/user/assets/images/logo.svg')}}" alt="logo">
                </a>
                <!-- Logo END -->
                ...
                <ul class="nav flex-nowrap align-items-center ms-sm-3 list-unstyled">
                    ...
                    <li class="nav-item dropdown ms-2">
                        <a class="nav-link bg-light icon-md btn btn-light p-0" href="#" id="notifDropdown"
                            ...
                            <li class="px-3">
                                <div class="d-flex align-items-center position-relative">
                                    ...
                                    <div class="avatar me-3">
                                        <img class="avatar-img rounded-circle" src="{{asset('public/user/assets/images/avatar/07.jpg')}}"
                                            alt="avatar">
                                    </div>
                                    <div>
            ...
            <div class="row g-4">
                    ...
                    <nav class="navbar navbar-expand-lg mx-0">
                        <div class="offcanvas offcanvas-start" tabindex="-1" id="offcanvasSideNavbar">
                            ...
                            <div class="offcanvas-body d-block px-2 px-lg-0">
                                ...
                                <!-- Helper link END -->
                                <!-- Copyright -->
                                <p class="small text-center mt-1">©{{date('Y')}} <a class="text-reset" target="_blank"
                                        href=""> Oldmanclub </a></p>
                            </div>
                        </div>
                    </nav>
                ...
                <div class="col-md-8 col-lg-6 vstack gap-4">
                    ...
                    <div class="d-flex gap-2 mb-n3">
                        ...
                        <!-- Stories -->
                        <div id="stories"
                            class="storiesWrapper stories-square stories user-icon carousel scroll-enable"></div>
                    </div>
                    <!-- Story END --> --}}
                    ...
                    {{-- <div class="card">
                        ...
                        <div class="card-body position-relative bg-light">
                            <a href="#!" class="small stretched-link"></a>
                    ...
                    {{-- <div>
                        ...
                        <div class="tiny-slider arrow-hover overflow-hidden">
                            <div class="tiny-slider-inner ms-n4" data-arrow="true" data-dots="true"
                                    ...
                                    <div class="card card-overlay-bottom border-0 position-relative h-150px"
                                        ...
                                        <div class="card-img-overlay d-flex align-items-center p-2">
                                            <div class="w-100 mt-auto">
                                                <!-- Name -->
                                                <a href="#!" class="stretched-link text-white small">Judy
                                                    Nguyen</a>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div>
                                    ...
                                    <div class="card card-overlay-bottom border-0 position-relative h-150px"
                                        ...
                                        <div class="card-img-overlay d-flex align-items-center p-2">
                                            <div class="w-100 mt-auto">
                                                <!-- Name -->
                                                <a href="#!" class="stretched-link text-white small">Amanda
                                                    Reed</a>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div>
                                    ...
                                    <div class="card card-overlay-bottom border-0 position-relative h-150px"
                                        ...
                                        <div class="card-img-overlay d-flex align-items-center p-2">
                                            <div class="w-100 mt-auto">
                                                <!-- Name -->
                                                <a href="#!" class="stretched-link text-white small">Lori
                                                    Stevens</a>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div>
                                    ...
                                    <div class="card card-overlay-bottom border-0 position-relative h-150px"
                                        ...
                                        <div class="card-img-overlay d-flex align-items-center p-2">
                                            <div class="w-100 mt-auto">
                                                <!-- Name -->
                                                <a href="#!" class="stretched-link text-white small">Joan
                                                    Wallace</a>
                                            </div>
                                        </div>
                                    </div>
