                            ...
                            <div id="about-me" class="tab-pane fade">
                                ...
                                <div class="profile-personal-info">
                                    ...
                                    <div class="row mb-4">
                                        ...
                                        <div class="col-9"><span>{{$client->first_name_en}}
                                        {{$client->middle_name_en}}{{$client->last_name_en}}
                                        </span>
                                        </div>
                                    </div>
                                    <div class="row mb-4">
                                    ...
                                    <div class="row mb-4">
                                        ...
                                        <div class="col-9"><span>{{$client->contact_en}}</span>
                                        </div>
                                    </div>
                                    <div class="row mb-4">
                                        <div class="col-3">
                            ...
                            <div id="profile-settings" class="tab-pane fade">
                                <div class="pt-3">
                                    <div class="settings-form">
                                        ...
                                        <form method="post" enctype="multipart/form-data" action="{{route('user_save_profile')}}">
                                            @csrf
                                            <div class="form-row">
                                                <div class="form-group col-md-6">
                                                    <label>First Name</label>
                                                    <input type="text" placeholder="" value="{{$client->first_name_en}}" class="form-control" name="first_name_en">
                                                </div>
                                                <div class="form-group col-md-6">
                                                    <label>Middle Name</label>
                                                    <input type="text" placeholder="" value="{{$client->middle_name_en}}" class="form-control" name="middle_name_en">
                                                </div>
                                                <div class="form-group col-md-6">
                                                    <label>Last Name</label>
                                                    <input type="text" placeholder="" value="{{$client->last_name_en}}" class="form-control" name="last_name_en">
                                                </div>
                                                <div class="form-group col-md-6">
                                                    <label>Email</label>
                                                    <input type="email" placeholder="Email" value="{{$client->email}}"class="form-control" name="email">
                                                </div>
                                                <div class="form-group col-md-6">
                                                    <label>Date Of Birth</label>
                                                    <input type="date" placeholder="" value="{{$client->date_of_birth}}" class="form-control" name="date_of_birth">
                                                </div>
                                                <div class="form-group col-md-6">
                                                    <label>Contact No</label>
                                                    <input type="text" placeholder="" value="{{$client->contact_en}}" class="form-control" name="contact_en">
                                                </div>
                                                
                                                
                                                <div class="form-group col-md-6">
                                                    <label>Nationality</label>
                                                    <input type="text" placeholder="" value="{{$client->nationality}}" class="form-control" name="nationality">
                                                </div>
                                                <div class="form-group col-md-6">
                                                    <label>Id No</label>
                                                    <input type="text" placeholder="" value="{{$client->id_no}}" class="form-control" name="id_no">
                                                </div>
                                                <div class="form-group col-md-6">
                                                    <label>Id Type</label>
                                                    <select name="id_no_type" id="" value="{{$client->id_no_type}}" class="form-control">
                                                        <option value="0"
                                                        @if(old('id_no_type',$client->id_no_type)==0) selected @endif>Passport</option>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" placeholder="" value="{{$client->address_line_1}}" class="form-control" name="address_line_1">
                                            </div>
                                            <div class="form-group">
                                                <label>Parmanent Address</label>
                                                <input type="text" placeholder="" value="{{$client->address_line_2}}" class="form-control" name="address_line_2">
                                            </div>
                                            <div class="form-row">
                                                <div class="form-group col-md-3">
                                                    <label>Country</label>
                                                    <input type="text" placeholder="" value="{{$client->country}}" class="form-control" name="country">
                                                </div>
                                                <div class="form-group col-md-3">
                                                    <label>city</label>
