        ...
        <div class="header_sleek">
            <div class="sleek_header_image">
                <div class="css-79elbk">
                    <img src="assets/images/123.png" alt="" srcset="">
                </div>
            </div>
            <div class="css-1fbwa35">
                <div class="card sleek_card">
                    <div class="card_img mx-auto">
                        <img src="assets/images/header_image.png" width="100px" alt="" srcset="">
                    </div>
                    ...
                    <div class="CardBox">
                        <p class="CardTitle css-70iv32 mx-auto">Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged.</p>
                    </div>
