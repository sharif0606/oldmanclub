    ...
    <div class="row">
        ...
        <div class="col-md-6 col-12">
            <div class="form-group">
                ...
                <input type="text" id="discount" class="form-control" value="{{ old('discount',$sms->discount)}}" name="discount" oninput="calculateDiscountPrice()">
            </div>
        </div>
        <div class="col-md-6 col-12">
            <div class="form-group">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 col-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="validity" class="form-control" value="{{ old('validity',$sms->validity)}}" name="validity">
