...
<div class="col-lg-12">
    <div class="card">
        ...
        <div class="card-body">
            <form action="{{route('printvideo.update',encryptor('encrypt',$printvideo->id))}}" method="post"
                        ...
                        <div class="row">
                            <div class="col-lg-6 mb-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="text_large"
                                        value="{{ old('text_large',$printvideo->text_large)}}" class="form-control">
                            ...
                            <div class="col-lg-6 mb-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="text_small"
                                        value="{{ old('text_small',$printvideo->text_small)}}" class="form-control">
                            ...
                            <div class="col-lg-6 mb-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="video_link"
                                        value="{{ old('video_link',$printvideo->video_link)}}" class="form-control">
