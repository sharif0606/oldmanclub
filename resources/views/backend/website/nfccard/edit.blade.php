...
<div class="col-lg-12">
    <div class="card">
        ...
        <div class="card-body">
            <form action="{{route('nfccard.update',encryptor('encrypt',$nfccard->id))}}" method="post" enctype="multipart/form-data" id="step-form-horizontal" class="step-form-horizontal">
                @csrf
                @method('PATCH')
                <div>
                    <h4></h4>
                        ...
                        <div class="row">
                            <div class="col-lg-6 mb-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="header_text_large" value="{{ old('header_text_large',$nfccard->header_text_large)}}" class="form-control">
                            ...
                            <div class="col-lg-6 mb-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="header_text_small" value="{{ old('header_text_small',$nfccard->header_text_small)}}" class="form-control">
                            ...
                            <div class="col-lg-6 mb-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="video_link" value="{{ old('video_link',$nfccard->video_link)}}" class="form-control">
                            ...
                            <div class="col-lg-6 mb-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="feature_list" value="{{ old('feature_list', implode(', ', $nfccard->feature_list))}}" class="form-control">
