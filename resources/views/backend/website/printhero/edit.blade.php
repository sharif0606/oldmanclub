...
<div class="col-lg-12">
    <div class="card">
        ...
        <div class="card-body">
            <form action="{{route('printhero.update',encryptor('encrypt',$printhero->id))}}" method="post"
                            ...
                            <div class="col-lg-6 mb-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="text_large"
                                        value="{{ old('text_large',$printhero->text_large)}}" class="form-control">
                            ...
                            <div class="col-lg-6 mb-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="text_small"
                                        value="{{ old('text_small',$printhero->text_small)}}" class="form-control">
