...
<div class="col-lg-12">
    <div class="card">
        ...
        <div class="card-body">
            <form action="{{route('nfccardprice.store')}}" method="post" enctype="multipart/form-data" id="step-form-horizontal" class="step-form-horizontal">
                @csrf
                <div>
                    <h4></h4>
                    <section>
                        <div class="row">
                            <div class="col-lg-6 mb-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="nfc_card_name" value="{{ old('nfc_card_name')}}" class="form-control">
                            ...
                            <div class="col-lg-6 mb-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="card_price" value="{{ old('card_price')}}" class="form-control">
                            ...
                            <div class="col-lg-6 mb-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="card_title" value="{{ old('card_title')}}" class="form-control">
                            ...
                            <div class="col-lg-6 mb-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="card_feature_list" value="{{ old('card_feature_list')}}" class="form-control">
