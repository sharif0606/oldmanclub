...
<div class="col-lg-12">
    <div class="card">
        ...
        <div class="card-body">
            <form action="{{route('llccard.store')}}" method="post" enctype="multipart/form-data" id="step-form-horizontal" class="step-form-horizontal">
                @csrf
                <div>
                    <h4></h4>
                    <section>
                        <div class="row">
                            ...
                            <div class="col-lg-6 mb-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="contact_text_large" value="{{ old('contact_text_large')}}" class="form-control">
                            ...
                            <div class="col-lg-6 mb-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="contact_text_small" value="{{ old('contact_text_small')}}" class="form-control">
