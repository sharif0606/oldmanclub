...
<div class="col-lg-12">
    <div class="card">
        ...
        <div class="card-body">
            <form action="{{route('shippingservice.update',encryptor('encrypt',$service->id))}}" method="post" enctype="multipart/form-data" id="step-form-horizontal" class="step-form-horizontal">
                @csrf
                @method('Patch')
                <div>
                    <h4></h4>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6 mb-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="service_description" value="{{ old('service_description',$service->service_description)}}" class="form-control">
