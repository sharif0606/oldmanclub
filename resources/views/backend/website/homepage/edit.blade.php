...
<div class="col-lg-12">
    <div class="card">
        ...
        <div class="card-body">
            <form action="{{route('homepage.update',encryptor('encrypt',$homepage->id))}}" method="post" enctype="multipart/form-data" id="step-form-horizontal" class="step-form-horizontal">
                @csrf
                @method('PATCH')
                <div>
                    <h4></h4>
                        ...
                        <div class="row">
                            <div class="col-lg-6 mb-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="service_section_text" value="{{ old('service_section_text',$homepage->service_section_text)}}" class="form-control">
                            ...
                            <div class="col-lg-6 mb-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="special_offer_text" value="{{ old('special_offer_text',$homepage->special_offer_text)}}" class="form-control">
                            ...
                            <div class="col-lg-6 mb-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="special_offer_link" value="{{ old('special_offer_link',$homepage->special_offer_link)}}" class="form-control">
                            ...
                            <div class="col-lg-6 mb-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="global_network_text" value="{{ old('global_network_text',$homepage->global_network_text)}}" class="form-control">
                            ...
                            <div class="col-lg-6 mb-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="customer_feedback_text" value="{{ old('customer_feedback_text',$homepage->customer_feedback_text)}}" class="form-control">
