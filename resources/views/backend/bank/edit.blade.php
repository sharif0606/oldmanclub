    ...
    <div class="col-12">
        <div class="card">
            <div class="card-content">
                <div class="card-body">
                    <form class="form" method="post" enctype="multipart/form-data" action="{{route('bank_update',encryptor('encrypt',$bank->id))}}">
                        @csrf
                        @method('post')
                        <div class="row">
                            <div class="col-md-6 col-12">
                                <div class="form-group">
                                    ...
                                    <select name="status" id="" class="form-control">
                                        <option value="1" @if(old('status',$bank->status)==1)selected @endif > Pending</option>
                                 
                                        <option value="2" @if(old('status',$bank->status)==2)selected @endif > Accepted</option>
                                
                                        <option value="3" @if(old('status',$bank->status)==3)selected @endif > Rejected</option>
                                    </select>
                                </div>
                            </div>
                            <!-- <div class="col-md-6 col-12">
